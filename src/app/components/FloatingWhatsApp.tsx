export function FloatingWhatsApp() {
  ...
  return (
      <button
        ...
        className="fixed sm:hidden bottom-6 right-6 z-50 bg-[#25D366] hover:bg-[#20BD5A] text-white p-4 rounded-full shadow-lg transition-transform duration-200 active:scale-95"
      ...
      <span className="absolute right-full mr-3 top-1/2 -translate-y-1/2 bg-gray-900 text-white px-3 py-2 rounded-lg text-sm whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
        ...
        <span className="hidden sm:absolute sm:inset-0 sm:rounded-full sm:bg-[#25D366] sm:animate-ping sm:opacity-20"></span>
